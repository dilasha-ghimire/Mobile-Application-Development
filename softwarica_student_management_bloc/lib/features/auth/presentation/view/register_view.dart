...
class _RegisterViewState extends State<RegisterView> {
  ...
  //isRestricted || isDenied - to allow use for old and new versions of the mobile
  ...
  //image_picker package recognizes imageSource as camera and gallery
  //thus, there is one function for both options

  //File type - can mean image or video or other file types (flexible)
  File? _img;
